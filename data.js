...
const PROPOSAL = {
 ...
 en: "K-Beauty Distribution Partnership Proposal — for our Brazil Partner",
 pt: "Proposta de Parceria de Distribuição de K-Beauty — para nosso Parceiro do Brasil"
 },
 ...
 logos: [
   ...
   { src: "assets/brands/aldicom.jpg", name: "aldicom" },
   ...
   { src: "assets/brands/brand_71.png", name: "미라클티켓" },
 ...
 { id: "agenda", ko: "아젠다", en: "Agenda", pt: "Agenda" },
 { id: "questions", ko: "질문", en: "Questions", pt: "Perguntas" },
 { id: "interpreter", ko: "통역사 안내", en: "Interpreter", pt: "Intérprete" },
 ...
 ko: "브라질 측 파트너는 현지 법인, 수입자, 유통망, 판매 채널, 투자·운영 자본을 담당합니다.",
 en: "The Brazil-side Partner brings the local entity, importer, distribution network, sales channels and investment/operating capital.",
 pt: "O Parceiro do lado brasileiro traz a entidade local, o importador, a rede de distribuição, os canais de venda e o capital de investimento/operação."
 },
 {
 ...
 brazil: {
 label: { ko: "Brazil-side Partner — 현지 운영", en: "Brazil-side Partner — Local Operation", pt: "Parceiro do Brasil — Operação Local" },
 items: [
...
/* ---------- ROADMAP ---------- */
 ...
 /* ---------- QUESTIONS ---------- */
 questions: {
 title: { ko: "Brazil-side Partner에게 물어볼 질문", en: "Questions for the Brazil-side Partner", pt: "Perguntas ao Parceiro do Brasil" },
 items: [
 ...
 background: {
 ko: "이 미팅은 ROUTE82(한국 측 실행 파트너)와 Brazil-side Partner(브라질 측 사업가 가족)가 브라질 K-Beauty 유통 사업을 논의하는 첫 미팅입니다. 한국어 중심으로 진행되며 필요 시 브라질 포르투갈어로 순차통역됩니다. 본 자료는 계약서가 아니라 'partnership discussion / pilot proposal'입니다.",
 en: "This is a first meeting between ROUTE82 (Korea-side operating partner) and the Brazil-side Partner (the Brazilian businessperson's family) to discuss a Brazil K-Beauty distribution business. Conducted mainly in Korean with consecutive interpretation into Brazilian Portuguese. This is a partnership discussion / pilot proposal, not a contract.",
 pt: "Esta é uma primeira reunião entre a ROUTE82 (parceira operacional na Coreia) e o Parceiro do Brasil (a família do empresário brasileiro) para discutir um negócio de distribuição de K-Beauty no Brasil. Conduzida principalmente em coreano, com interpretação consecutiva para o português do Brasil. Trata-se de uma discussão de parceria / proposta piloto, não de um contrato."
 },
 ...
 { term: "Brazil-side Partner", note: { ko: "브라질 측 사업가 가족 (익명 표기)", en: "Brazilian businessperson's family (anonymized)", pt: "Família do empresário brasileiro (anonimizado)" } },
